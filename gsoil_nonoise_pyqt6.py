...
BIAS_1, PEAK_1 = 11.6e-3, 28.9e-3
BIAS_2, PEAK_2 = 0.0, 30e-3
PERIOD_1, PULSE_1 = SIM//2, (SIM//2)//1.6
PERIOD_2, PULSE_2 = 5000, 3000
...
class LaserPlotter(QMainWindow):
    def __init__(self, t, s_hist_prim, s_hist_sec,
        ...
        # --- Figure ---
        self.fig, self.axs = plt.subplots(2, 1, figsize=(12, 7), sharex=True, gridspec_kw={'height_ratios':[2,1], 'hspace':0.3})
